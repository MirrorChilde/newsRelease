          ...
          <el-col :span="news.image != null ? 18 : 24">
            <div class="grid-content">
              <div class="two-right">
                ...
                <div class="text" v-html="news.content" @click="newsDetail(news.id)">
                </div>
                <!-- <p ></p> -->
              </div>
            </div>
      ...
      <div v-else class="box-contain">
        <el-card class="box-card" v-for="user in news_list" :key="user.userId">
          <div slot="header" class="clearfix">
            ...
            <el-button style="float: right; padding: 3px 0" type="text" v-if="user.focus"
              @click="focusUser('delete', user.focusId)">取消关注</el-button>
            <el-button style="float: right; padding: 3px 0" type="text" v-else
              @click="focusUser('put', user.userId)">+关注</el-button>
          </div>
